...
public class PlayTheGame {
    public static void main(String[] args) throws IllegalArgumentException, SingleUseMethodException {
        ...
        PrintPlainText plaintTxtPrinter = new PrintPlainText();
        PrintHTML HTMLTxtPrinter = new PrintHTML();

        var char1 = new CharacterWarrior("Katniss", 110, "bow", "knife");
        HTMLTxtPrinter.printStats(char1);
        System.out.println("");

        var char2 = new CharacterWarrior("Xena", 92, "short sword");
        HTMLTxtPrinter.printStats(char2);
        System.out.println("");

        var char4 = new CharacterRogue("Alexander Hamilton", 90);
        HTMLTxtPrinter.printStats(char4);
        System.out.println("");

        var char5 = new CharacterRogue("Aaron Burr", 91);
        HTMLTxtPrinter.printStats(char5);
        System.out.println("");
        ...
        HTMLTxtPrinter.printFightLog(outcome);
    }
